...
const en: Translations = {
  ...
  adminReview: {
    ...
    billCountSingle: '1 bill',
    updateStatus: 'Approve or Reject',
    rejectRequiresReason: 'A reason is required to reject this bill.',
  ...
  uploadExpense: {
    ...
    uploadSuccessBody: 'Files submitted successfully.',
  ...
  reviewBatch: {
    ...
    almostDone: 'Almost done! The tanuki is excited! 🎉',
    updateSuccessTitle: 'Updated!',
    updateSuccessBody: 'Changes saved.',
    removeSuccessTitle: 'Removed',
    removeSuccessBody: 'Bill deleted.',
    submitSuccessTitle: 'Submitted! 🎉',
    submitSuccessBody: 'Bills submitted.',
    errorTitle: 'An error occurred',
    errorBody: 'Please try again.',
  },
  submitSuccess: {
